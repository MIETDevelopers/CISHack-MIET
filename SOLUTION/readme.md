...
<body>
  ...
  <main id="main">
    <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
      ...
      <div class="carousel-inner">
          ...
          <div class="container-fluid">
            <div class="row">
              ...
              <img class="d-block w-100"
                src="https://static9.depositphotos.com/1034517/1091/v/600/depositphotos_10910036-stock-illustration-blood-donation.jpg"
                alt="Second slide" class="col-lg-12 col-sm-12 ml-sm-auto mr-sm-auto img-responsive" height="450">
            </div>
        ...
        <div class="carousel-item">
          <img class="d-block w-100" src="https://miro.medium.com/proxy/1*xFNqxHNTuUa8czXh_Uoceg.jpeg" alt="Third slide"
            height="450">
        </div>
      </div>
  ...
  <div class="container-fluid" style="background-color: #fdfdfd; padding: 140px 0;" id="aboutt">
    <div class="container-fluid">
  ...
  <div
   ...
   <a href=" ./register.html" style="text-decoration: none;"> <button
    ...
    <h3 class="h3-responsive text-center"
      style="margin-top: 8%;font-size: 45px;font-family: 'Montserrat', sans-serif;font-weight: 700;">
      Log In as :</h3>
    <div style="margin-left: 23%;margin-right: 23%;background-color: rgb(170, 170, 170);""><hr></div>
...
<div class=" card-deck" id="#profiles " style="margin-left: 25%;margin-right: 25%;">
      ...
      <div class="row">
        <div class="col-12 col-sm-6 col-md-4 col-lg-3">
          <div class="our-team">
            ...
            <div class="team-content">
              <h3 class="name">SUHAIL AHMAD PARRAY</h3>
        ...
        <div class="col-12 col-sm-6 col-md-4 col-lg-3">
          <div class="our-team">
            ...
            <div class="team-content">
              <h3 class="name">MOHSIN</h3>
              <h4 class="title">PYTHON PROGRAMMER</h4>
            </div>
            <ul class="social">
              <li><a href="" class="fa fa-facebook" aria-hidden="true"></a></li>
              <li><a href="" class="fa fa-twitter" aria-hidden="true"></a></li>
        ...
        <div class="col-12 col-sm-6 col-md-4 col-lg-3">
          <div class="our-team">
            ...
            <div class="team-content">
              <h3 class="name">HAAMID </h3>
              <h4 class="title">CSE STUDENT</h4>
            </div>
            <ul class="social">
              <li><a href="" class="fa fa-facebook" aria-hidden="true"></a></li>
              <li><a href="" class="fa fa-twitter" aria-hidden="true"></a></li>
    ...
    <footer class="footer">
      <div class="footer-left">
        ...
        <p>&copy soub 2020, This is the live website and developed by suhail ahmad parray</p>
      </div>
...
<script>
  var firebaseConfig = {
    apiKey: "AIzaSyAKroI-X-ENWmClZL4zBGLBZHL63rcvfJI",
    authDomain: "healthtech-2c043.firebaseapp.com",
    databaseURL: "https://healthtech-2c043-default-rtdb.firebaseio.com",
    projectId: "healthtech-2c043",
    storageBucket: "healthtech-2c043.appspot.com",
    messagingSenderId: "518750478844",
    appId: "1:518750478844:web:f686770f4696df21325279",
    measurementId: "G-1RE2NZX8EM"
  };
